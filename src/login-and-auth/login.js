...
export const loginAndLogout = new Elysia()
.use(jwt({
  name:"jwt",
  secret: process.env.JWT_SECRET

}))
.get("accounts/github/login", async ({redirect , cookie: {github_oauth_state}}) => {
...
.get("accounts/github/login/callback", async ({query, cookie : {github_oauth_state, user_Cookie}}) => {
